...
long long _main() {
    ...
    ok = expect_equal((long long)"no SIMPLER assembly reaches 1/alpha (generated grammar, complete)", int_to_string(fine_structure_assembly_is_minimal()), int_to_string(1));
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
