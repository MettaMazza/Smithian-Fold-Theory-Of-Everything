...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the muon g-2 anomaly (the muon is the sharp probe) ===");
    ok = expect_equal((long long)"bare Dirac g = binary count = 2", int_to_string(muon_bare_g_factor()), (long long)"2");
    ok = expect_equal((long long)"forced m_mu/m_e = 207.0 (leading cubic; measured 206.768, 0.16%)", fraction_to_decimal(muon_electron_mass_ratio(), 1), (long long)"207.0");
    ok = expect_equal((long long)"sensitivity (m_mu/m_e)^2 = 42886 (muon out-probes electron)", fraction_to_decimal(anomaly_sensitivity_ratio(), 0), (long long)"42886");
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
