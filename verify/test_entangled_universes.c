...
long long _main();
long long entangled_state();
long long shadow_in(long long, long long);
long long shadows_before();
long long folded_whole();
long long both_worlds_reach_origin();
long long local_laws_agree();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== entangled composites (one state, two worlds, one origin) ===");
    ok = expect_bool((long long)"the shadows before: 2 in the 3-world, 3 in the 5-world", shadows_before());
    ok = expect_equal((long long)"one fold of the whole: 8/15 -> 1/15", int_to_string(folded_whole()), (long long)"1");
    ok = expect_bool((long long)"BOTH worlds reach their origin together (1, 1)", both_worlds_reach_origin());
    ok = expect_bool((long long)"each world's local law agrees (no signal crossed)", local_laws_agree());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long shadow_in(long long i, long long p) {
    long long s = 0;
    long long ret_val = 0;
...
long long shadows_before() {
    long long five_ok = 0;
    long long five_shadow = 0;
    long long three_ok = 0;
    long long three_shadow = 0;
    long long z = 0;
    long long ret_val = 0;
    ...
    z = 8;
    three_shadow = shadow_in(z, 3);
    five_shadow = shadow_in(z, 5);
    three_ok = three_shadow == 2;
    five_ok = five_shadow == 3;
    if (three_ok) {
    ret_val = five_ok;
    goto L_cleanup;
    }
...
long long both_worlds_reach_origin() {
    ...
    landed = folded_whole();
    three_shadow = shadow_in(landed, 3);
    five_shadow = shadow_in(landed, 5);
    three_ok = three_shadow == 1;
    five_ok = five_shadow == 1;
    if (three_ok) {
    ret_val = five_ok;
    goto L_cleanup;
    }
...
long long local_laws_agree() {
    long long five_local = 0;
    long long three_local = 0;
    long long ret_val = 0;
