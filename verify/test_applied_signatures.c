...
long long _main();
long long smithion_coupling(long long);
long long electromagnetically_dark();
long long new_jet_multiplicity(long long);
long long new_jets_are_counted();
long long beyond_seven_falsifies();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== applied signatures: finding the Smithions and the new forces ===");
    ok = expect_equal((long long)"the penta Smithion's only coupling g = 4/5 (confined)", fraction_to_text(smithion_coupling(5)), (long long)"4/5");
    ok = expect_equal((long long)"the hepta Smithion's only coupling g = 6/7 (confined)", fraction_to_text(smithion_coupling(7)), (long long)"6/7");
    ok = expect_bool((long long)"ELECTROMAGNETICALLY DARK: no ordinary recoil channel (gravitational search)", electromagnetically_dark());
    ok = expect_equal((long long)"the PENTA confining-jet multiplicity: 24 carriers", int_to_string(new_jet_multiplicity(5)), (long long)"24");
    ok = expect_equal((long long)"the HEPTA confining-jet multiplicity: 48 carriers", int_to_string(new_jet_multiplicity(7)), (long long)"48");
    ok = expect_bool((long long)"new jets counted (24 penta, 48 hepta)", new_jets_are_counted());
    ok = expect_bool((long long)"THE SEAL: a confining signature beyond prime 7 falsifies the theory", beyond_seven_falsifies());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long smithion_coupling(long long p) {
    long long ret_val = 0;
...
long long electromagnetically_dark() {
    long long g5 = 0;
    long long g5_confined = 0;
    long long g7 = 0;
    long long g7_confined = 0;
    long long one = 0;
    long long ret_val = 0;
    ...
    g5 = sector_coupling(5);
    g5_confined = fraction_compare(g5, one) < 0;
    g7 = sector_coupling(7);
    g7_confined = fraction_compare(g7, one) < 0;
    if (g5_confined) {
    ret_val = g7_confined;
    goto L_cleanup;
    }
...
L_cleanup:
    ep_gc_pop_roots(3);
    free_struct_Fraction(g5);
    g5 = 0;
    free_struct_Fraction(g7);
    g7 = 0;
...
long long new_jet_multiplicity(long long p) {
    long long ret_val = 0;
...
long long new_jets_are_counted() {
    ...
    penta = sector_mediator_count(5) == 24;
    hepta = sector_mediator_count(7) == 48;
    if (penta) {
    ret_val = hepta;
    goto L_cleanup;
    }
