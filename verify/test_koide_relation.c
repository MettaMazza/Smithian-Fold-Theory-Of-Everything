...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the Koide relation ===");
    ok = expect_equal((long long)"sum of sqrt-masses = sum of roots = 1", fraction_to_text(sum_of_root_masses()), (long long)"1");
    ok = expect_equal((long long)"sum of masses = 1 - 2*(1/6) = 2/3", fraction_to_text(sum_of_lepton_masses()), (long long)"2/3");
    ok = expect_equal((long long)"Koide ratio Q = 2/3", fraction_to_text(koide_ratio()), (long long)"2/3");
    ok = expect_equal((long long)"Koide ratio = 1 - 1/colour = 2/3 (independent route)", fraction_to_text(koide_from_colour()), (long long)"2/3");
    printf("%s\n", (char*)(long long)"--- to the measured value ---");
    ok = expect_equal((long long)"forced Q = 0.666666", fraction_to_decimal(koide_ratio(), 6), (long long)"0.666666");
    ok = expect_equal((long long)"measured Q = 0.666661 (five-digit agreement)", fraction_to_decimal(fraction_from_ratio(666661, 1000000), 6), (long long)"0.666661");
    ok = expect_equal((long long)"the Koide FORM Q = 1 - 2*e2 is unique (forced_unique)", int_to_string(koide_form_is_unique()), (long long)"1");
    ok = expect_equal((long long)"no SIMPLER assembly reaches Q (engine-generated, complete)", int_to_string(koide_assembly_is_minimal()), (long long)"1");
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
