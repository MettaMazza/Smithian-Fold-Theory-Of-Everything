...
long long _main();
long long ladder_exponent();
long long energy_level(long long);
long long lyman_alpha();
long long balmer_alpha();
long long levels_descend_toward_ionization();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the hydrogen spectrum ===");
    ok = expect_equal((long long)"ladder exponent = binary = 2 (1/n^2)", int_to_string(ladder_exponent()), int_to_string(2));
    ok = expect_equal((long long)"level n=1 = 1", fraction_to_text(energy_level(1)), (long long)"1");
    ok = expect_equal((long long)"level n=2 = 1/4", fraction_to_text(energy_level(2)), (long long)"1/4");
    ok = expect_equal((long long)"level n=3 = 1/9", fraction_to_text(energy_level(3)), (long long)"1/9");
    ok = expect_equal((long long)"Lyman-alpha (2->1) = 3/4", fraction_to_text(lyman_alpha()), (long long)"3/4");
    ok = expect_equal((long long)"Balmer-alpha (3->2) = 5/36", fraction_to_text(balmer_alpha()), (long long)"5/36");
    ok = expect_bool((long long)"levels descend toward ionization (the forbidden zero)", levels_descend_toward_ionization());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long energy_level(long long n) {
    ...
    denominator = whole_power(n, ladder_exponent());
...
long long levels_descend_toward_ionization() {
    long long third = 0;
    long long first = 0;
    long long drop_two = 0;
    long long drop_one = 0;
    long long second = 0;
    long long ret_val = 0;
    ...
    first = energy_level(1);
    second = energy_level(2);
    third = energy_level(3);
    drop_one = fraction_compare(first, second);
    drop_two = fraction_compare(second, third);
    if (drop_one > 0) {
    if (drop_two > 0) {
    ret_val = 1LL;
    goto L_cleanup;
