...
long long _main();
long long sound_signal_speed();
long long fundamental();
long long harmonic(long long);
long long nth_harmonic_is_whole_multiple(long long);
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== acoustics (the harmonic series) ===");
    ok = expect_equal((long long)"sound signal speed = the One", fold_value_to_text(sound_signal_speed()), (long long)"1");
    ok = expect_equal((long long)"fundamental f0 = 1/6", fraction_to_text(fundamental()), (long long)"1/6");
    ok = expect_equal((long long)"1st harmonic = 1/6", fraction_to_text(harmonic(1)), (long long)"1/6");
    ok = expect_equal((long long)"2nd harmonic = 2 * f0 = 1/3", fraction_to_text(harmonic(2)), (long long)"1/3");
    ok = expect_equal((long long)"3rd harmonic = 3 * f0 = 1/2", fraction_to_text(harmonic(3)), (long long)"1/2");
    ok = expect_bool((long long)"the 3rd harmonic is a whole multiple of the fundamental", nth_harmonic_is_whole_multiple(3));
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long harmonic(long long n) {
    ...
    f0 = fraction_from_ratio(1, 6);
    ret_val = fraction_multiply(n_fraction, f0);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(3);
    return ret_val;
...
long long nth_harmonic_is_whole_multiple(long long n) {
    long long ratio = 0;
    long long f0 = 0;
    long long n_fraction = 0;
    long long f_n = 0;
    ...
    f_n = harmonic(n);
    f0 = fraction_from_ratio(1, 6);
    ratio = fraction_divide(f_n, f0);
    n_fraction = fraction_from_whole_number(n);
    ret_val = fraction_compare(ratio, n_fraction) == 0;
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(5);
    free_struct_Fraction(ratio);
    ratio = 0;
    free_struct_Fraction(n_fraction);
    n_fraction = 0;
    return ret_val;
}
