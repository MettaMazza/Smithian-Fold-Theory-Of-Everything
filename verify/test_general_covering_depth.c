...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the general covering principle (m^d for every generator) ===");
    ok = expect_bool((long long)"ternary depth 2, state 5/9 arrives within two triplings", state_arrives_under(5, 3, 2));
    ok = expect_equal((long long)"the ternary census at depth 1 = 3", int_to_string(census_of_tower(3, 1)), (long long)"3");
    ok = expect_equal((long long)"the ternary census at depth 2 = 9 = 3^2", int_to_string(census_of_tower(3, 2)), (long long)"9");
    ok = expect_equal((long long)"the binary census at depth 3 = 8 (same law)", int_to_string(census_of_tower(2, 3)), (long long)"8");
    ok = expect_bool((long long)"THE PRINCIPLE: m^d for every generator -- one law, no per-sector axiom", covering_principle_holds());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
