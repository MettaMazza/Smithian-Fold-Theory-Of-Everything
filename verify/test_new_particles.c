...
long long _main();
long long smithion_i2_denominator(long long, long long);
long long smithion_down_depth(long long);
long long smithion_up_depth(long long);
...
long long smithion_root(long long, long long, long long, long long, long long);
long long spectrum_i1_denominator(long long, long long);
long long spectrum_i2_denominator(long long, long long);
long long spectrum_generations(long long, long long);
long long spectrum_mass_ratio(long long, long long, long long);
long long quark_invariants_cross_check();
...
long long sharpened_invariant(long long);
long long lift_cubic_value(long long, long long, long long);
long long lift_root(long long, long long, long long, long long, long long, long long);
long long down_bare_ratio();
long long up_bare_ratio();
long long lift_factor_counted();
long long lands_on_two(long long);
...
long long _main() {
    ...
    ep_gc_push_root(&one);
    ep_gc_push_root(&penta_r2);
    ep_gc_push_root(&r2_down);
    ep_gc_push_root(&r2_up);
    ep_gc_push_root(&r3_down);

    ep_gc_maybe_collect();

    printf("%s\n", (char*)(long long)"=== the Smithions: the matter of the new forces, fully derived ===");
    ok = expect_bool((long long)"THE ANCHOR: unified I2 equals the independent quark invariants at c=3", quark_invariants_cross_check());
    ok = expect_equal((long long)"I2 denominator at (3,5): the quark down 1454", int_to_string(smithion_i2_denominator(3, 5)), (long long)"1454");
    ok = expect_equal((long long)"I2 denominator at (3,7): the quark up 13118", int_to_string(smithion_i2_denominator(3, 7)), (long long)"13118");
    ok = expect_equal((long long)"the quark down spectrum has THREE generations (sign changes found, not chosen)", int_to_string(spectrum_generations(3, 0)), (long long)"3");
    ok = expect_equal((long long)"the quark up spectrum has THREE generations", int_to_string(spectrum_generations(3, 1)), (long long)"3");
    r2_down = spectrum_mass_ratio(3, 0, 2);
    ok = expect_equal((long long)"VALIDATION c=3 down: s/d = 20.11 (measured 20)", fraction_to_decimal(r2_down, 2), (long long)"20.11");
    r3_down = spectrum_mass_ratio(3, 0, 3);
    ok = expect_equal((long long)"VALIDATION c=3 down: b/d = 967.19 (measured ~890 bare)", fraction_to_decimal(r3_down, 2), (long long)"967.19");
    r2_up = spectrum_mass_ratio(3, 1, 2);
    ok = expect_equal((long long)"VALIDATION c=3 up: c/u = 486.35 (measured 577 bare)", fraction_to_decimal(r2_up, 2), (long long)"486.35");
    ok = expect_equal((long long)"PENTA down-type: THREE generations forced", int_to_string(spectrum_generations(5, 0)), (long long)"3");
    ok = expect_equal((long long)"PENTA up-type: THREE generations forced", int_to_string(spectrum_generations(5, 1)), (long long)"3");
    ok = expect_equal((long long)"HEPTA down-type: THREE generations forced", int_to_string(spectrum_generations(7, 0)), (long long)"3");
    ok = expect_equal((long long)"HEPTA up-type: THREE generations forced", int_to_string(spectrum_generations(7, 1)), (long long)"3");
    penta_r2 = spectrum_mass_ratio(5, 0, 2);
    one = fraction_from_whole_number(1);
    ok = expect_bool((long long)"the PENTA tower is enormously split (gen2 >> gen1)", fraction_compare(penta_r2, one) == 1);
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
    ...
    one = 0;
    free_struct_Fraction(penta_r2);
    penta_r2 = 0;
    free_struct_Fraction(r2_down);
    r2_down = 0;
    free_struct_Fraction(r2_up);
    r2_up = 0;
    free_struct_Fraction(r3_down);
    r3_down = 0;
    return ret_val;
}

long long smithion_i2_denominator(long long c, long long d) {
    long long body = 0;
    long long ret_val = 0;
    ...
    body = whole_power(c, d);
    ret_val = ((c * ((2 * body) - 1)) - 1);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long smithion_down_depth(long long c) {
    long long ret_val = 0;
    ...
    ret_val = minimal_binary_cover(whole_power(c, 3));
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long smithion_up_depth(long long c) {
    long long ret_val = 0;
    ...
    ret_val = minimal_binary_cover(whole_power(c, 4));
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long smithion_i1_up_denominator(long long c) {
    long long ret_val = 0;
...
long long smithion_cubic(long long y, long long i1_num, long long i1_den, long long i2_num, long long i2_den) {
    ...
    ep_gc_push_root(&i1);
    ep_gc_push_root(&i2);
    ep_gc_push_root(&linear);
    ep_gc_push_root(&with_linear);
    ep_gc_push_root(&y_cubed);
    ep_gc_push_root(&y_squared);
    ep_gc_push_root(&y_third);
    ep_gc_push_root(&y_twin);
    ep_gc_push_root(&y);
    ep_gc_push_root(&i1_num);
    ep_gc_push_root(&i1_den);
    ep_gc_push_root(&i2_num);
    ep_gc_push_root(&i2_den);

    ep_gc_maybe_collect();

    y_twin = fraction_make(fraction_numerator(y), fraction_denominator(y));
    y_squared = fraction_multiply(y, y_twin);
    y_third = fraction_make(fraction_numerator(y), fraction_denominator(y));
    y_cubed = fraction_multiply(y_squared, y_third);
    i1 = fraction_from_ratio(i1_num, i1_den);
    linear = fraction_multiply(i1, y);
    cubic_minus_square = fraction_subtract(y_cubed, y_squared);
    with_linear = fraction_add(cubic_minus_square, linear);
    i2 = fraction_from_ratio(i2_num, i2_den);
    ret_val = fraction_subtract(with_linear, i2);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(14);
    return ret_val;
...
long long smithion_sign_changes(long long i1_num, long long i1_den, long long i2_num, long long i2_den) {
    long long changes = 0;
    long long current = 0;
    long long k = 0;
...
long long smithion_nth_change(long long i1_num, long long i1_den, long long i2_num, long long i2_den, long long n) {
    long long current = 0;
    long long k = 0;
    long long previous = 0;
    long long seen = 0;
...
long long smithion_root(long long i1_num, long long i1_den, long long i2_num, long long i2_den, long long which) {
    ...
    ep_gc_push_root(&i2_num);
    ep_gc_push_root(&i2_den);
    ep_gc_push_root(&which);

    ep_gc_maybe_collect();

    k = smithion_nth_change(i1_num, i1_den, i2_num, i2_den, which);
    lo = fraction_from_ratio((k - 1), 1024);
    hi = fraction_from_ratio(k, 1024);
    zero = fraction_from_whole_number(0);
    two_fraction = fraction_from_whole_number(2);
    value_at_lo = smithion_cubic(lo, i1_num, i1_den, i2_num, i2_den);
    ...
    value_at_mid = smithion_cubic(mid, i1_num, i1_den, i2_num, i2_den);
    ...
    ret_val = fraction_divide(final_sum, two_fraction);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(15);
    return ret_val;
...
long long spectrum_i1_denominator(long long c, long long kind_up) {
    long long ret_val = 0;
...
long long spectrum_i2_denominator(long long c, long long kind_up) {
    long long d = 0;
    long long d_down = 0;
    long long ret_val = 0;
    ...
    if (kind_up == 1) {
    d = minimal_binary_cover(whole_power(c, 4));
    ret_val = smithion_i2_denominator(c, d);
    goto L_cleanup;
    }
    d_down = minimal_binary_cover(whole_power(c, 3));
    ret_val = smithion_i2_denominator(c, d_down);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(3);
    return ret_val;
...
long long spectrum_generations(long long c, long long kind_up) {
    long long i1_den = 0;
    long long i2_den = 0;
    long long ret_val = 0;
    ...
    ep_gc_push_root(&i2_den);
    ep_gc_push_root(&c);
    ep_gc_push_root(&kind_up);

    ep_gc_maybe_collect();

    i1_den = spectrum_i1_denominator(c, kind_up);
    i2_den = spectrum_i2_denominator(c, kind_up);
    ret_val = smithion_sign_changes(1, i1_den, c, i2_den);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(4);
    return ret_val;
...
long long spectrum_mass_ratio(long long c, long long kind_up, long long which) {
    long long heavy = 0;
    long long heavy_squared = 0;
    long long heavy_twin = 0;
    long long i1_den = 0;
    long long i2_den = 0;
    long long lifted = 0;
    long long lightest = 0;
    long long lightest_squared = 0;
    long long lightest_twin = 0;
    long long two = 0;
    long long ret_val = 0;

    ep_gc_push_root(&heavy);
    ep_gc_push_root(&heavy_squared);
    ep_gc_push_root(&heavy_twin);
    ep_gc_push_root(&i1_den);
    ep_gc_push_root(&i2_den);
    ep_gc_push_root(&lifted);
    ep_gc_push_root(&lightest);
    ep_gc_push_root(&lightest_squared);
    ep_gc_push_root(&lightest_twin);
    ep_gc_push_root(&two);
    ep_gc_push_root(&c);
    ep_gc_push_root(&kind_up);
    ep_gc_push_root(&which);
    ...
    i1_den = spectrum_i1_denominator(c, kind_up);
    i2_den = spectrum_i2_denominator(c, kind_up);
    lightest = smithion_root(1, i1_den, c, i2_den, 1);
    lightest_twin = fraction_make(fraction_numerator(lightest), fraction_denominator(lightest));
    lightest_squared = fraction_multiply(lightest, lightest_twin);
    two = fraction_from_whole_number(2);
    lifted = fraction_multiply(two, lightest_squared);
    heavy = smithion_root(1, i1_den, c, i2_den, which);
    heavy_twin = fraction_make(fraction_numerator(heavy), fraction_denominator(heavy));
    heavy_squared = fraction_multiply(heavy, heavy_twin);
    ret_val = fraction_divide(heavy_squared, lifted);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(13);
    return ret_val;
...
long long quark_invariants_cross_check() {
    long long corpus_down = 0;
    long long corpus_up = 0;
    long long down_den = 0;
    long long down_ok = 0;
    long long unified_down = 0;
    long long unified_up = 0;
    long long up_den = 0;
    long long up_ok = 0;
    long long ret_val = 0;

    ep_gc_push_root(&corpus_down);
    ep_gc_push_root(&corpus_up);
    ep_gc_push_root(&down_den);
    ep_gc_push_root(&unified_down);
    ep_gc_push_root(&unified_up);
    ep_gc_push_root(&up_den);

    ep_gc_maybe_collect();

    down_den = smithion_i2_denominator(3, 5);
    unified_down = fraction_from_ratio(3, down_den);
    corpus_down = sharpened_invariant(5);
    down_ok = fraction_compare(unified_down, corpus_down) == 0;
    up_den = smithion_i2_denominator(3, 7);
    unified_up = fraction_from_ratio(3, up_den);
    corpus_up = sharpened_invariant(7);
    up_ok = fraction_compare(unified_up, corpus_up) == 0;
    if (down_ok) {
    ret_val = up_ok;
    goto L_cleanup;
    }
...
L_cleanup:
    ep_gc_pop_roots(6);
    free_struct_Fraction(corpus_down);
    corpus_down = 0;
    free_struct_Fraction(corpus_up);
    corpus_up = 0;
    free_struct_Fraction(unified_down);
    unified_down = 0;
    free_struct_Fraction(unified_up);
    unified_up = 0;
    return ret_val;
}
...
long long sharpened_invariant(long long d) {
    long long denominator = 0;
    long long tower = 0;
    long long ret_val = 0;
    ...
    tower = whole_power(colour_count(), d);
    denominator = ((6 * tower) - 4);
    ret_val = fraction_from_ratio(3, denominator);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long lift_cubic_value(long long x, long long e2, long long e3) {
    long long e2_term = 0;
    long long head = 0;
    long long with_linear = 0;
    long long x_cubed = 0;
    ...
    head = fraction_subtract(x_cubed, x_squared);
    with_linear = fraction_add(head, e2_term);
...
long long lift_root(long long lo_num, long long lo_den, long long hi_num, long long hi_den, long long e2, long long e3) {
    long long bracket_sum = 0;
    long long count = 0;
    long long final_sum = 0;
    long long hi = 0;
    ...
    zero = fraction_from_whole_number(0);
    two_fraction = fraction_from_whole_number(2);
    value_at_lo = lift_cubic_value(lo, e2, e3);
    sign_at_lo = fraction_compare(value_at_lo, zero);
    count = 0;
    while (count < 40) {
    bracket_sum = fraction_add(lo, hi);
    mid = fraction_divide(bracket_sum, two_fraction);
    value_at_mid = lift_cubic_value(mid, e2, e3);
    sign_at_mid = fraction_compare(value_at_mid, zero);
    if (sign_at_mid == sign_at_lo) {
    lo = mid;
    } else {
...
long long down_bare_ratio() {
    ...
    long long light_twin = 0;
    long long middle = 0;
    long long middle_mass = 0;
    long long middle_twin = 0;
    long long ret_val = 0;
    ...
    ep_gc_push_root(&light_twin);
    ep_gc_push_root(&middle);
    ep_gc_push_root(&middle_mass);
    ep_gc_push_root(&middle_twin);

    ep_gc_maybe_collect();

    e2 = fraction_from_ratio(1, 8);
    e3 = sharpened_invariant(5);
    light = lift_root(1, 1000, 1, 20, e2, e3);
    middle = lift_root(8, 100, 2, 10, e2, e3);
    light_twin = fraction_make(fraction_numerator(light), fraction_denominator(light));
    light_mass = fraction_multiply(light, light_twin);
    middle_twin = fraction_make(fraction_numerator(middle), fraction_denominator(middle));
    middle_mass = fraction_multiply(middle, middle_twin);
    ret_val = fraction_divide(middle_mass, light_mass);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(8);
    return ret_val;
...
long long up_bare_ratio() {
    ...
    e3 = sharpened_invariant(7);
    light = lift_root(1, 10000, 1, 100, e2, e3);
    middle = lift_root(5, 100, 15, 100, e2, e3);
    light_twin = fraction_make(fraction_numerator(light), fraction_denominator(light));
    light_mass = fraction_multiply(light, light_twin);
    middle_twin = fraction_make(fraction_numerator(middle), fraction_denominator(middle));
    middle_mass = fraction_multiply(middle, middle_twin);
...
long long lift_factor_counted() {
    ...
    i = 1;
    while (i < 3) {
    candidate = fraction_from_ratio(i, 2);
    twin = fraction_make(fraction_numerator(candidate), fraction_denominator(candidate));
    doubled = fraction_add(candidate, twin);
    folded = cast_out_whole_ones(doubled);
...
long long lands_on_two(long long value) {
    long long allowed = 0;
    ...
    two = fraction_from_whole_number(2);
    gap = fraction_subtract(value, two);
    ...
    allowed = fraction_from_ratio(2, 1000);
