...
long long rare_beneficial();
long long after_one_generation();
long long after_two_generations();
long long selection_amplifies();
long long reaches_fixation();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== evolution by descent ===");
    ok = expect_equal((long long)"rare beneficial variant = 1/4", fraction_to_text(rare_beneficial()), (long long)"1/4");
    ok = expect_equal((long long)"after one generation of selection = 1/2", fraction_to_text(after_one_generation()), (long long)"1/2");
    ok = expect_equal((long long)"after two generations = 1 (fixation)", fraction_to_text(after_two_generations()), (long long)"1");
    ok = expect_bool((long long)"selection AMPLIFIES the variant (it climbs)", selection_amplifies());
    ok = expect_bool((long long)"the variant reaches fixation at the One", reaches_fixation());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long after_one_generation() {
    ...
    ret_val = fold_fraction(rare_beneficial());
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
...
long long after_two_generations() {
    ...
    once = fold_fraction(rare_beneficial());
...
long long selection_amplifies() {
    ...
    stepped = fold_fraction(rare_beneficial());
...
long long reaches_fixation() {
    ...
    reached = after_two_generations();
    one = fraction_from_whole_number(1);
    ret_val = fraction_compare(reached, one) == 0;
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
