...
long long perturbation();
long long perturbation_after_one_step();
long long perturbation_after_two_steps();
long long perturbation_grows();
long long perturbation_reaches_unison();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== structure formation ===");
    ok = expect_equal((long long)"growth step one: fold(1/4) = 1/2", fraction_to_text(perturbation_after_one_step()), (long long)"1/2");
    ok = expect_equal((long long)"growth step two: fold(1/2) = 1", fraction_to_text(perturbation_after_two_steps()), (long long)"1");
    ok = expect_bool((long long)"the perturbation GROWS (does not decay)", perturbation_grows());
    ok = expect_bool((long long)"the perturbation reaches unison (a structure) in two steps", perturbation_reaches_unison());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long perturbation_after_one_step() {
    ...
    ret_val = fold_fraction(perturbation());
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
...
long long perturbation_after_two_steps() {
    ...
    once = fold_fraction(perturbation());
...
long long perturbation_grows() {
    ...
    stepped = fold_fraction(perturbation());
...
long long perturbation_reaches_unison() {
    ...
    reached = perturbation_after_two_steps();
