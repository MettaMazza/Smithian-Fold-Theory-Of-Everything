...
long long input_one();
long long input_two();
long long sum_frequency();
long long difference_frequency();
long long second_harmonic();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== three-wave mixing ===");
    ok = expect_equal((long long)"input one f1 = 1/3", fraction_to_text(input_one()), (long long)"1/3");
    ok = expect_equal((long long)"input two f2 = 1/4", fraction_to_text(input_two()), (long long)"1/4");
    ok = expect_equal((long long)"sum frequency f1 + f2 = 7/12", fraction_to_text(sum_frequency()), (long long)"7/12");
    ok = expect_equal((long long)"difference frequency f1 - f2 = 1/12", fraction_to_text(difference_frequency()), (long long)"1/12");
    ok = expect_equal((long long)"second harmonic of f2 = 1/2 (f2 doubled)", fraction_to_text(second_harmonic()), (long long)"1/2");
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long sum_frequency() {
    ...
    f1 = fraction_from_ratio(1, 3);
    f2 = fraction_from_ratio(1, 4);
    ret_val = fraction_add(f1, f2);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long difference_frequency() {
    ...
    f1 = fraction_from_ratio(1, 3);
    f2 = fraction_from_ratio(1, 4);
    ret_val = fraction_subtract(f1, f2);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long second_harmonic() {
    ...
    ret_val = fold_fraction(input_two());
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
