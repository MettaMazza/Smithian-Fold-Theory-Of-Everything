...
long long _main();
long long ladder_position(long long);
long long shortfall_of(long long);
long long set_is_mirror_closed();
long long triple_sum();
long long square_root_in_bracket(long long, long long, long long, long long, long long, long long);
long long share_root(long long);
long long size_of(long long);
long long shares_root_the_cubic();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the proven mass ratios (mirror-closed, cubic-rooted) ===");
    ok = expect_bool((long long)"MIRROR CLOSURE: every shortfall is again a position (exact)", set_is_mirror_closed());
    ok = expect_equal((long long)"the triple's sum = 3/2 (route-independent by symmetry)", fraction_to_text(triple_sum()), (long long)"3/2");
    ok = expect_bool((long long)"CUBIC ROOTING: all three normalized shares root the cubic (1/10^9)", shares_root_the_cubic());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long ladder_position(long long i) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio(((2 * i) - 1), 6);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long shortfall_of(long long i) {
    long long one = 0;
    ...
    position = fraction_from_ratio(((2 * i) - 1), 6);
    ret_val = fraction_subtract(one, position);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(3);
    return ret_val;
...
long long set_is_mirror_closed() {
    ...
    i = 1;
    while (i < 4) {
    shortfall = shortfall_of(i);
    found = 0LL;
    j = 1;
    while (j < 4) {
    position = fraction_from_ratio(((2 * j) - 1), 6);
    matches = fraction_compare(shortfall, position) == 0;
    if (matches) {
    found = 1LL;
    }
    j = (j + 1);
...
L_cleanup:
    ep_gc_pop_roots(4);
    free_struct_Fraction(position);
    position = 0;
    free_struct_Fraction(shortfall);
    shortfall = 0;
    return ret_val;
}
...
long long triple_sum() {
    ...
    first = fraction_from_ratio(1, 6);
    second = fraction_from_ratio(3, 6);
    third = fraction_from_ratio(5, 6);
    pair = fraction_add(first, second);
    ret_val = fraction_add(pair, third);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(4);
    return ret_val;
...
long long square_root_in_bracket(long long t_num, long long t_den, long long lo_num, long long lo_den, long long hi_num, long long hi_den) {
    ...
    long long lo = 0;
    long long mid = 0;
    long long mid_squared = 0;
    long long mid_twin = 0;
    long long target = 0;
    ...
    ep_gc_push_root(&lo);
    ep_gc_push_root(&mid);
    ep_gc_push_root(&mid_squared);
    ep_gc_push_root(&mid_twin);
    ...
    target = fraction_from_ratio(t_num, t_den);
    ...
    mid_twin = fraction_make(fraction_numerator(mid), fraction_denominator(mid));
    mid_squared = fraction_multiply(mid, mid_twin);
    comparison = fraction_compare(mid_squared, target);
    if (comparison < 0) {
    lo = mid;
    } else {
    hi = mid;
...
long long share_root(long long i) {
    long long ret_val = 0;

    if (i == 1) {
    ret_val = square_root_in_bracket(1, 6, 2, 5, 1, 2);
    goto L_cleanup;
    }
    if (i == 2) {
    ret_val = square_root_in_bracket(1, 2, 7, 10, 3, 4);
    goto L_cleanup;
    }
    ret_val = square_root_in_bracket(5, 6, 9, 10, 1, 1);
    goto L_cleanup;
L_cleanup:
    return ret_val;
}

long long size_of(long long value) {
    long long zero = 0;
    long long ret_val = 0;
...
long long shares_root_the_cubic() {
    long long all_root = 0;
    long long comparison = 0;
    long long e2 = 0;
    long long e2_a = 0;
    long long e2_b = 0;
    long long e2_c = 0;
    long long e2_partial = 0;
    long long e3 = 0;
    long long e3_pair = 0;
    long long head = 0;
    long long i = 0;
    long long j1 = 0;
    long long j1_local = 0;
    long long j2 = 0;
    long long j2_local = 0;
    long long linear = 0;
    long long pair = 0;
    long long residue = 0;
    long long residue_size = 0;
    long long scale = 0;
    long long scale_cubed = 0;
    long long scale_local = 0;
    long long scale_squared = 0;
    long long scale_third = 0;
    long long scale_twin = 0;
    long long tolerance = 0;
    long long with_linear = 0;
    long long x = 0;
    long long x1 = 0;
    long long x1_third = 0;
    long long x1_twin = 0;
    long long x2 = 0;
    long long x2_third = 0;
    long long x2_twin = 0;
    long long x3 = 0;
    long long x3_third = 0;
    long long x3_twin = 0;
    long long y = 0;
    long long y_cubed = 0;
    long long y_fourth = 0;
    ...
    ep_gc_push_root(&e2_b);
    ep_gc_push_root(&e2_c);
    ep_gc_push_root(&e2_partial);
    ep_gc_push_root(&e3);
    ep_gc_push_root(&e3_pair);
    ep_gc_push_root(&head);
    ep_gc_push_root(&i);
    ep_gc_push_root(&j1);
    ep_gc_push_root(&j1_local);
    ep_gc_push_root(&j2);
    ep_gc_push_root(&j2_local);
    ep_gc_push_root(&linear);
    ep_gc_push_root(&pair);
    ep_gc_push_root(&residue);
    ep_gc_push_root(&residue_size);
    ep_gc_push_root(&scale);
    ep_gc_push_root(&scale_cubed);
    ep_gc_push_root(&scale_local);
    ep_gc_push_root(&scale_squared);
    ep_gc_push_root(&scale_third);
    ep_gc_push_root(&scale_twin);
    ep_gc_push_root(&tolerance);
    ep_gc_push_root(&with_linear);
    ep_gc_push_root(&x);
    ep_gc_push_root(&x1);
    ep_gc_push_root(&x1_third);
    ep_gc_push_root(&x1_twin);
    ep_gc_push_root(&x2);
    ep_gc_push_root(&x2_third);
    ep_gc_push_root(&x2_twin);
    ep_gc_push_root(&x3);
    ep_gc_push_root(&x3_third);
    ep_gc_push_root(&x3_twin);
    ep_gc_push_root(&y);
    ep_gc_push_root(&y_cubed);
    ep_gc_push_root(&y_fourth);
    ...
    x2 = share_root(2);
    x3 = share_root(3);
    pair = fraction_add(x1, x2);
    scale = fraction_add(pair, x3);
    e2_a = fraction_multiply(x1, x2);
    x2_twin = fraction_make(fraction_numerator(x2), fraction_denominator(x2));
    e2_b = fraction_multiply(x2_twin, x3);
    x1_twin = fraction_make(fraction_numerator(x1), fraction_denominator(x1));
    x3_twin = fraction_make(fraction_numerator(x3), fraction_denominator(x3));
    e2_c = fraction_multiply(x3_twin, x1_twin);
    e2_partial = fraction_add(e2_a, e2_b);
    e2 = fraction_add(e2_partial, e2_c);
    x1_third = fraction_make(fraction_numerator(x1), fraction_denominator(x1));
    x2_third = fraction_make(fraction_numerator(x2), fraction_denominator(x2));
    x3_third = fraction_make(fraction_numerator(x3), fraction_denominator(x3));
    e3_pair = fraction_multiply(x1_third, x2_third);
    e3 = fraction_multiply(e3_pair, x3_third);
    scale_twin = fraction_make(fraction_numerator(scale), fraction_denominator(scale));
    scale_squared = fraction_multiply(scale, scale_twin);
    scale_third = fraction_make(fraction_numerator(scale), fraction_denominator(scale));
    scale_cubed = fraction_multiply(scale_squared, scale_third);
    j1 = fraction_divide(e2, scale_squared);
    j2 = fraction_divide(e3, scale_cubed);
    tolerance = fraction_from_ratio(1, 1000000000);
    all_root = 1LL;
    i = 1;
    while (i < 4) {
    x = share_root(i);
    scale_local = fraction_make(fraction_numerator(scale), fraction_denominator(scale));
    y = fraction_divide(x, scale_local);
    ...
    j1_local = fraction_make(fraction_numerator(j1), fraction_denominator(j1));
    y_fourth = fraction_make(fraction_numerator(y), fraction_denominator(y));
    linear = fraction_multiply(j1_local, y_fourth);
    head = fraction_subtract(y_cubed, y_squared);
    with_linear = fraction_add(head, linear);
    j2_local = fraction_make(fraction_numerator(j2), fraction_denominator(j2));
    residue = fraction_subtract(with_linear, j2_local);
    residue_size = size_of(residue);
    comparison = fraction_compare(residue_size, tolerance);
    if (comparison < 0) {
    all_root = all_root;
    } else {
    all_root = 0LL;
...
L_cleanup:
    ep_gc_pop_roots(41);
    free_struct_Fraction(j1);
    j1 = 0;
    free_struct_Fraction(j2);
    j2 = 0;
    return ret_val;
}
