...
long long _main();
long long sector_holding_coupling(long long);
long long tripling_preimage(long long, long long);
long long generation_separation(long long, long long);
long long built_diagonal(long long);
long long built_off_diagonal(long long);
long long closed_diagonal(long long);
long long closed_off_diagonal(long long);
long long routes_agree_at(long long);
long long quark_anchor_holds();
long long generation_leakage(long long);
long long leakage_shrinks();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the dark-CKM: generation mixing for the new sectors ===");
    ok = expect_equal((long long)"the strong holding coupling (p-1)/p at p=3", fraction_to_text(sector_holding_coupling(3)), (long long)"2/3");
    ok = expect_equal((long long)"the penta holding coupling at p=5", fraction_to_text(sector_holding_coupling(5)), (long long)"4/5");
    ok = expect_equal((long long)"the hepta holding coupling at p=7", fraction_to_text(sector_holding_coupling(7)), (long long)"6/7");
    ok = expect_bool((long long)"ROUTE A = ROUTE B and near-diagonal at p=3", routes_agree_at(3));
    ok = expect_bool((long long)"ROUTE A = ROUTE B and near-diagonal at p=5", routes_agree_at(5));
    ok = expect_bool((long long)"ROUTE A = ROUTE B and near-diagonal at p=7", routes_agree_at(7));
    ok = expect_bool((long long)"THE ANCHOR: p=3 reproduces the corpus quark values 8/9 and 5/9", quark_anchor_holds());
    ok = expect_equal((long long)"quark diagonal V_ii at p=3", fraction_to_text(built_diagonal(3)), (long long)"8/9");
    ok = expect_equal((long long)"quark off-diagonal V_12 at p=3", fraction_to_text(built_off_diagonal(3)), (long long)"5/9");
    ok = expect_equal((long long)"PENTA diagonal V_ii at p=5 (new, forced)", fraction_to_text(built_diagonal(5)), (long long)"14/15");
    ok = expect_equal((long long)"PENTA off-diagonal V_12 at p=5", fraction_to_text(built_off_diagonal(5)), (long long)"3/5");
    ok = expect_equal((long long)"HEPTA diagonal V_ii at p=7 (new, forced)", fraction_to_text(built_diagonal(7)), (long long)"20/21");
    ok = expect_equal((long long)"HEPTA off-diagonal V_12 at p=7", fraction_to_text(built_off_diagonal(7)), (long long)"13/21");
    ok = expect_equal((long long)"the generation leakage 1/(3p) at p=3", fraction_to_text(generation_leakage(3)), (long long)"1/9");
    ok = expect_equal((long long)"the generation leakage at p=7", fraction_to_text(generation_leakage(7)), (long long)"1/21");
    ok = expect_bool((long long)"the leakage SHRINKS along the ladder: heavier colour, calmer mixing", leakage_shrinks());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long sector_holding_coupling(long long p) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio((p - 1), p);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long tripling_preimage(long long base, long long i) {
    long long base_for_build = 0;
    long long base_for_check = 0;
    long long folded = 0;
    long long lands = 0;
    long long preimage = 0;
    long long preimage_twin = 0;
    long long shift = 0;
    long long shifted = 0;
    long long three = 0;
    long long three_again = 0;
    long long tripled = 0;
    long long ret_val = 0;

    ep_gc_push_root(&base_for_build);
    ep_gc_push_root(&base_for_check);
    ep_gc_push_root(&folded);
    ep_gc_push_root(&preimage);
    ep_gc_push_root(&preimage_twin);
    ep_gc_push_root(&shift);
    ep_gc_push_root(&shifted);
    ep_gc_push_root(&three);
    ep_gc_push_root(&three_again);
    ...
    base_for_build = fraction_make(fraction_numerator(base), fraction_denominator(base));
    base_for_check = fraction_make(fraction_numerator(base), fraction_denominator(base));
    shift = fraction_from_whole_number(i);
    shifted = fraction_add(base_for_build, shift);
    three = fraction_from_whole_number(3);
    preimage = fraction_divide(shifted, three);
    preimage_twin = fraction_make(fraction_numerator(preimage), fraction_denominator(preimage));
    three_again = fraction_from_whole_number(3);
    tripled = fraction_multiply(three_again, preimage_twin);
    folded = cast_out_whole_ones(tripled);
    lands = fraction_compare(folded, base_for_check) == 0;
    if (lands) {
    ret_val = preimage;
    goto L_cleanup;
    }
    ret_val = fraction_from_ratio(1, 1000000007);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(12);
    return ret_val;
...
long long generation_separation(long long p, long long i) {
    long long channel_i = 0;
    long long coupling = 0;
    long long mass_i = 0;
    long long one = 0;
    long long ret_val = 0;

    ep_gc_push_root(&channel_i);
    ep_gc_push_root(&coupling);
    ep_gc_push_root(&mass_i);
    ep_gc_push_root(&one);
    ep_gc_push_root(&p);
    ep_gc_push_root(&i);
    ...
    coupling = fraction_from_ratio((p - 1), p);
    mass_i = tripling_preimage(coupling, i);
    one = fraction_from_whole_number(1);
    channel_i = tripling_preimage(one, i);
    ret_val = fraction_subtract(channel_i, mass_i);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(6);
    return ret_val;
...
long long built_diagonal(long long p) {
    long long one = 0;
    long long sep = 0;
    long long sep0 = 0;
    long long sep0_twin = 0;
    long long sep1 = 0;
    long long sep1_matches = 0;
    long long sep2_matches = 0;
    long long sep2_twin = 0;
    long long symmetric = 0;
    long long ret_val = 0;

    ep_gc_push_root(&one);
    ep_gc_push_root(&sep);
    ep_gc_push_root(&sep0);
    ep_gc_push_root(&sep0_twin);
    ep_gc_push_root(&sep1);
    ep_gc_push_root(&sep2_twin);
    ep_gc_push_root(&p);

    ep_gc_maybe_collect();

    sep0 = generation_separation(p, 0);
    sep1 = generation_separation(p, 1);
    sep1_matches = fraction_compare(sep1, sep0) == 0;
    sep0_twin = generation_separation(p, 0);
    sep2_twin = generation_separation(p, 2);
    sep2_matches = fraction_compare(sep2_twin, sep0_twin) == 0;
    symmetric = 0LL;
    if (sep1_matches) {
    if (sep2_matches) {
    symmetric = 1LL;
    ...
    if (symmetric) {
    one = fraction_from_whole_number(1);
    sep = generation_separation(p, 0);
    ret_val = fraction_subtract(one, sep);
    goto L_cleanup;
    }
    ret_val = fraction_from_ratio(1, 1000000007);
    goto L_cleanup;
...
long long built_off_diagonal(long long p) {
    long long channel_1 = 0;
    long long coupling = 0;
    long long mass_0 = 0;
    long long one = 0;
    long long one_twin = 0;
    long long sep12 = 0;
    long long ret_val = 0;

    ep_gc_push_root(&channel_1);
    ep_gc_push_root(&coupling);
    ep_gc_push_root(&mass_0);
    ep_gc_push_root(&one);
    ep_gc_push_root(&one_twin);
    ep_gc_push_root(&sep12);
    ep_gc_push_root(&p);

    ep_gc_maybe_collect();

    coupling = fraction_from_ratio((p - 1), p);
    mass_0 = tripling_preimage(coupling, 0);
    one = fraction_from_whole_number(1);
    channel_1 = tripling_preimage(one, 1);
    sep12 = fraction_subtract(channel_1, mass_0);
    one_twin = fraction_from_whole_number(1);
    ret_val = fraction_subtract(one_twin, sep12);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(7);
    return ret_val;
...
long long closed_diagonal(long long p) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio(((3 * p) - 1), (3 * p));
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long closed_off_diagonal(long long p) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio(((2 * p) - 1), (3 * p));
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long routes_agree_at(long long p) {
    long long built_d = 0;
    long long built_d_twin = 0;
    long long built_o = 0;
    long long built_o_twin = 0;
    long long closed_d = 0;
    long long closed_o = 0;
    long long diag_ok = 0;
    long long near_diagonal = 0;
    long long off_ok = 0;
    long long ret_val = 0;

    ep_gc_push_root(&built_d);
    ep_gc_push_root(&built_d_twin);
    ep_gc_push_root(&built_o);
    ep_gc_push_root(&built_o_twin);
    ep_gc_push_root(&closed_d);
    ep_gc_push_root(&closed_o);
    ep_gc_push_root(&p);

    ep_gc_maybe_collect();

    built_d = built_diagonal(p);
    closed_d = fraction_from_ratio(((3 * p) - 1), (3 * p));
    diag_ok = fraction_compare(built_d, closed_d) == 0;
    built_o = built_off_diagonal(p);
    closed_o = fraction_from_ratio(((2 * p) - 1), (3 * p));
    off_ok = fraction_compare(built_o, closed_o) == 0;
    built_d_twin = built_diagonal(p);
    built_o_twin = built_off_diagonal(p);
    near_diagonal = fraction_compare(built_d_twin, built_o_twin) == 1;
    if (diag_ok) {
    if (off_ok) {
    ret_val = near_diagonal;
    goto L_cleanup;
    }
    }
    ret_val = 0LL;
...
L_cleanup:
    ep_gc_pop_roots(7);
    free_struct_Fraction(built_d);
    built_d = 0;
    free_struct_Fraction(built_d_twin);
    built_d_twin = 0;
    free_struct_Fraction(built_o);
    built_o = 0;
    free_struct_Fraction(built_o_twin);
    built_o_twin = 0;
    free_struct_Fraction(closed_d);
    closed_d = 0;
    free_struct_Fraction(closed_o);
    closed_o = 0;
    return ret_val;
}
...
long long quark_anchor_holds() {
    ...
    long long c = 0;
    long long diag_ok = 0;
    long long eight_ninths = 0;
    long long five_ninths = 0;
    long long off_ok = 0;
    long long ret_val = 0;
    ...
    ep_gc_push_root(&built_o);
    ep_gc_push_root(&c);
    ep_gc_push_root(&eight_ninths);
    ep_gc_push_root(&five_ninths);

    ep_gc_maybe_collect();

    c = smallest_fold_period_above(binary_count());
    built_d = built_diagonal(c);
    eight_ninths = fraction_from_ratio(8, 9);
    diag_ok = fraction_compare(built_d, eight_ninths) == 0;
    built_o = built_off_diagonal(c);
    five_ninths = fraction_from_ratio(5, 9);
    off_ok = fraction_compare(built_o, five_ninths) == 0;
    if (diag_ok) {
    ret_val = off_ok;
    goto L_cleanup;
    }
...
L_cleanup:
    ...
    free_struct_Fraction(built_o);
    built_o = 0;
    free_struct_Fraction(eight_ninths);
    eight_ninths = 0;
    free_struct_Fraction(five_ninths);
    five_ninths = 0;
    return ret_val;
}

long long generation_leakage(long long p) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio(1, (3 * p));
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long leakage_shrinks() {
    long long first_drop = 0;
    long long leak3 = 0;
    long long leak5 = 0;
    long long leak5_twin = 0;
    long long leak7 = 0;
    long long second_drop = 0;
    long long ret_val = 0;

    ep_gc_push_root(&leak3);
    ep_gc_push_root(&leak5);
    ep_gc_push_root(&leak5_twin);
    ep_gc_push_root(&leak7);

    ep_gc_maybe_collect();

    leak3 = fraction_from_ratio(1, 9);
    leak5 = fraction_from_ratio(1, 15);
    first_drop = fraction_compare(leak3, leak5) == 1;
    leak5_twin = fraction_from_ratio(1, 15);
    leak7 = fraction_from_ratio(1, 21);
    second_drop = fraction_compare(leak5_twin, leak7) == 1;
    if (first_drop) {
    ret_val = second_drop;
    goto L_cleanup;
    }
...
L_cleanup:
    ep_gc_pop_roots(4);
    free_struct_Fraction(leak3);
    leak3 = 0;
    free_struct_Fraction(leak5);
    leak5 = 0;
    free_struct_Fraction(leak5_twin);
    leak5_twin = 0;
    free_struct_Fraction(leak7);
    leak7 = 0;
    return ret_val;
}
