...
long long _main();
long long causal_speed();
long long gravitational_wave_speed();
long long gw_speed_equals_light();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== gravitational-wave speed (ripples travel at c) ===");
    ok = expect_equal((long long)"the causal speed is the One (c = 1)", fraction_to_text(causal_speed()), (long long)"1");
    ok = expect_equal((long long)"gravitational-wave speed = c = 1", fraction_to_text(gravitational_wave_speed()), (long long)"1");
    ok = expect_bool((long long)"gravitational waves travel at exactly the speed of light", gw_speed_equals_light());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long gw_speed_equals_light() {
    ...
    ret_val = fraction_compare(gravitational_wave_speed(), causal_speed()) == 0;
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
