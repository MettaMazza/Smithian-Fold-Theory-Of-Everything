...
long long _main();
long long matter_charge();
long long strong_coupling_at_level(long long);
long long strong_coupling_growth();
long long electromagnetic_coupling_at_level(long long);
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== asymptotic freedom ===");
    ok = expect_equal((long long)"strong coupling at level 0 = 1", fraction_to_text(strong_coupling_at_level(0)), (long long)"1");
    ok = expect_equal((long long)"strong coupling at level 1 = 3", fraction_to_text(strong_coupling_at_level(1)), (long long)"3");
    ok = expect_equal((long long)"strong coupling at level 2 = 5", fraction_to_text(strong_coupling_at_level(2)), (long long)"5");
    ok = expect_equal((long long)"strong coupling grows by 2 (= binary) per level", fraction_to_text(strong_coupling_growth()), (long long)"2");
    printf("%s\n", (char*)(long long)"--- electromagnetism does not run ---");
    ok = expect_equal((long long)"EM coupling at level 1 = 1", fraction_to_text(electromagnetic_coupling_at_level(1)), (long long)"1");
    ok = expect_equal((long long)"EM coupling at level 5 = 1 (flat)", fraction_to_text(electromagnetic_coupling_at_level(5)), (long long)"1");
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long strong_coupling_at_level(long long level) {
    long long matter = 0;
    long long numerator = 0;
    long long matter_denominator = 0;
    long long carrier_charge = 0;
    long long ret_val = 0;

    ep_gc_push_root(&matter);
    ep_gc_push_root(&numerator);
    ep_gc_push_root(&matter_denominator);
    ep_gc_push_root(&carrier_charge);
    ep_gc_push_root(&level);

    ep_gc_maybe_collect();

    matter = fraction_from_ratio(1, binary_count());
    carrier_charge = fraction_from_whole_number(level);
    numerator = fraction_add(matter, carrier_charge);
    matter_denominator = fraction_from_ratio(1, binary_count());
    ret_val = fraction_divide(numerator, matter_denominator);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(5);
    return ret_val;
...
long long strong_coupling_growth() {
    ...
    higher = strong_coupling_at_level(2);
    lower = strong_coupling_at_level(1);
...
long long electromagnetic_coupling_at_level(long long level) {
    long long matter_denominator = 0;
    long long matter = 0;
    long long ret_val = 0;
    ...
    matter = fraction_from_ratio(1, binary_count());
    matter_denominator = fraction_from_ratio(1, binary_count());
    ret_val = fraction_divide(matter, matter_denominator);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
