...
long long _main();
long long shell_capacity(long long);
long long first_shell();
long long second_shell();
long long third_shell();
long long fourth_shell();
long long helium_closure();
long long neon_closure();
long long octet();
long long argon_closure();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== electron shell capacities (2, 8, 18, 32) ===");
    ok = expect_equal((long long)"shell 1 holds b*1^2 = 2", int_to_string(first_shell()), (long long)"2");
    ok = expect_equal((long long)"shell 2 holds b*2^2 = 8", int_to_string(second_shell()), (long long)"8");
    ok = expect_equal((long long)"shell 3 holds b*3^2 = 18", int_to_string(third_shell()), (long long)"18");
    ok = expect_equal((long long)"shell 4 holds b*4^2 = 32", int_to_string(fourth_shell()), (long long)"32");
    ok = expect_equal((long long)"helium closes at 2", int_to_string(helium_closure()), (long long)"2");
    ok = expect_equal((long long)"neon closes at 10", int_to_string(neon_closure()), (long long)"10");
    ok = expect_equal((long long)"argon closes at 18 (neon + one octet)", int_to_string(argon_closure()), (long long)"18");
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long shell_capacity(long long n) {
    long long squared = 0;
    long long ret_val = 0;
    ...
    squared = whole_power(n, 2);
    ret_val = (smallest_fold_period_above(1) * squared);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long neon_closure() {
    ...
    ret_val = (shell_capacity(1) + shell_capacity(2));
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
...
long long argon_closure() {
    ...
    ret_val = ((shell_capacity(1) + shell_capacity(2)) + shell_capacity(2));
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
