...
long long _main();
long long dress_depth();
long long lift_scale();
long long up_dress_factor(long long);
long long down_lift_factor(long long);
long long dressed_t_over_c();
long long dressed_s_over_d();
long long dressed_b_over_s();
long long lands_within_threshold(long long, long long);
long long t_over_c_dressed_at(long long);
long long s_over_d_lifted_at(long long);
long long b_over_s_lifted_at(long long);
long long s_over_d_wrong_lift();
long long b_over_s_wrong_lift();
long long down_second_invariant();
long long up_second_invariant();
...
long long mass_share_of(long long);
long long bare_s_over_d();
long long bare_b_over_s();
long long bare_t_over_c();
long long brackets_carry_sign_changes();
...
long long _main() {
    long long bs_at_two = 0;
    long long ok = 0;
    long long sd_at_two = 0;
    long long target_bs = 0;
    long long target_sd = 0;
    long long target_tc = 0;
    long long ret_val = 0;

    ep_gc_push_root(&bs_at_two);
    ep_gc_push_root(&sd_at_two);
    ep_gc_push_root(&target_bs);
    ep_gc_push_root(&target_sd);
    ep_gc_push_root(&target_tc);

    ep_gc_maybe_collect();

    printf("%s\n", (char*)(long long)"=== the forced quark dressing (bare to measured, falsified alternatives) ===");
    ok = expect_equal((long long)"the dressing depth = d_up = 7 (forced)", int_to_string(dress_depth()), (long long)"7");
    ok = expect_equal((long long)"the lift scale = d_up - d_down = 2 (forced)", int_to_string(lift_scale()), (long long)"2");
    target_sd = fraction_from_ratio(1978, 100);
    target_bs = fraction_from_ratio(5394, 100);
    target_tc = fraction_from_ratio(10330, 100);
    ok = expect_bool((long long)"FORCED s/d lands on measured 19.78 (0.3% threshold)", lands_within_threshold(dressed_s_over_d(), target_sd));
    ok = expect_bool((long long)"FORCED b/s lands on measured 53.94", lands_within_threshold(dressed_b_over_s(), target_bs));
    ok = expect_bool((long long)"FORCED t/c lands on measured 103.30", lands_within_threshold(dressed_t_over_c(), target_tc));
    printf("%s\n", (char*)concat((long long)"  info  dressed s/d = ", fraction_to_decimal(dressed_s_over_d(), 4)));
    printf("%s\n", (char*)concat((long long)"  info  dressed b/s = ", fraction_to_decimal(dressed_b_over_s(), 4)));
    printf("%s\n", (char*)concat((long long)"  info  dressed t/c = ", fraction_to_decimal(dressed_t_over_c(), 4)));
    ok = expect_bool((long long)"B1: depth m2 = 2 is REJECTED for t/c", lands_within_threshold(t_over_c_dressed_at(2), target_tc) == 0LL);
    ok = expect_bool((long long)"B1: depth m3 = 3 is REJECTED for t/c", lands_within_threshold(t_over_c_dressed_at(3), target_tc) == 0LL);
    ok = expect_bool((long long)"B1: depth d_down = 5 is REJECTED for t/c", lands_within_threshold(t_over_c_dressed_at(5), target_tc) == 0LL);
    ok = expect_bool((long long)"B1: ONLY d_up = 7 lands t/c", lands_within_threshold(t_over_c_dressed_at(7), target_tc));
    ok = expect_bool((long long)"B2: scale 3 is REJECTED for the down pair", lands_within_threshold(s_over_d_lifted_at(3), target_sd) == 0LL);
    ok = expect_bool((long long)"B2: scale 5 is REJECTED", lands_within_threshold(s_over_d_lifted_at(5), target_sd) == 0LL);
    ok = expect_bool((long long)"B2: scale 7 is REJECTED", lands_within_threshold(s_over_d_lifted_at(7), target_sd) == 0LL);
    sd_at_two = lands_within_threshold(s_over_d_lifted_at(2), target_sd);
    bs_at_two = lands_within_threshold(b_over_s_lifted_at(2), target_bs);
    ok = expect_bool((long long)"B2: ONLY m2 = 2 lands BOTH down ratios", sd_at_two);
    ok = expect_bool((long long)"(and b/s at m2 = 2)", bs_at_two);
    ok = expect_bool((long long)"B3: lifting the LIGHTEST down mass is REJECTED", lands_within_threshold(s_over_d_wrong_lift(), target_sd) == 0LL);
    ok = expect_bool((long long)"B3: lifting the HEAVIEST down mass is REJECTED", lands_within_threshold(b_over_s_wrong_lift(), target_bs) == 0LL);
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(5);
    free_struct_Fraction(target_tc);
    target_tc = 0;
    return ret_val;
}
...
long long up_dress_factor(long long depth) {
    long long depth_fraction = 0;
    long long inv_alpha = 0;
    long long inv_alpha_again = 0;
    long long shifted = 0;
    long long ret_val = 0;

    ep_gc_push_root(&depth_fraction);
    ep_gc_push_root(&inv_alpha);
    ep_gc_push_root(&inv_alpha_again);
    ep_gc_push_root(&shifted);
    ep_gc_push_root(&depth);

    ep_gc_maybe_collect();

    inv_alpha = inverse_fine_structure_first_order();
    depth_fraction = fraction_from_whole_number(depth);
    shifted = fraction_add(inv_alpha, depth_fraction);
    inv_alpha_again = inverse_fine_structure_first_order();
    ret_val = fraction_divide(inv_alpha_again, shifted);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(5);
    return ret_val;
...
long long down_lift_factor(long long scale) {
    long long inv_alpha = 0;
    long long inv_alpha_again = 0;
    long long lifted = 0;
    long long scale_fraction = 0;
    long long ret_val = 0;

    ep_gc_push_root(&inv_alpha);
    ep_gc_push_root(&inv_alpha_again);
    ep_gc_push_root(&lifted);
    ep_gc_push_root(&scale_fraction);
    ep_gc_push_root(&scale);

    ep_gc_maybe_collect();

    inv_alpha = inverse_fine_structure_first_order();
    scale_fraction = fraction_from_whole_number(scale);
    lifted = fraction_add(inv_alpha, scale_fraction);
    inv_alpha_again = inverse_fine_structure_first_order();
    ret_val = fraction_divide(lifted, inv_alpha_again);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(5);
    return ret_val;
...
long long dressed_t_over_c() {
    ...
    ep_gc_push_root(&bare);
    ep_gc_push_root(&factor);

    ep_gc_maybe_collect();

    bare = bare_t_over_c();
    factor = up_dress_factor(dress_depth());
    ret_val = fraction_multiply(bare, factor);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long dressed_s_over_d() {
    ...
    bare = bare_s_over_d();
    k = down_lift_factor(lift_scale());
    ret_val = fraction_multiply(bare, k);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long dressed_b_over_s() {
    ...
    bare = bare_b_over_s();
    k = down_lift_factor(lift_scale());
    ret_val = fraction_divide(bare, k);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long lands_within_threshold(long long value, long long target) {
    long long allowed = 0;
    ...
    ep_gc_push_root(&allowed);
    ep_gc_push_root(&gap);
    ep_gc_push_root(&threshold);
    ...
    gap = fraction_subtract(value, target);
    ...
    threshold = fraction_from_ratio(3, 1000);
    allowed = fraction_multiply(threshold, target);
    comparison = fraction_compare(gap, allowed);
...
long long t_over_c_dressed_at(long long depth) {
    long long bare = 0;
    long long factor = 0;
    long long ret_val = 0;
...
long long s_over_d_lifted_at(long long scale) {
    long long bare = 0;
    long long k = 0;
    long long ret_val = 0;
...
long long b_over_s_lifted_at(long long scale) {
    long long bare = 0;
    long long k = 0;
    long long ret_val = 0;
...
long long down_second_invariant() {
    ...
    reach = whole_power(binary_count(), 7);
    denominator = ((smallest_fold_period_above(binary_count()) * reach) - 1);
...
long long up_second_invariant() {
    ...
    reach = whole_power(binary_count(), 10);
    denominator = ((smallest_fold_period_above(binary_count()) * reach) - 1);
    ret_val = fraction_from_ratio(1, denominator);
    goto L_cleanup;
L_cleanup:
...
long long up_first_invariant_here() {
    ...
    ret_val = fraction_from_ratio(1, 12);
    goto L_cleanup;
L_cleanup:
    return ret_val;
}

long long quark_cubic_value(long long x, long long e2, long long e3) {
    ...
    ep_gc_push_root(&x_third);
    ep_gc_push_root(&x_twin);
    ep_gc_push_root(&x);
    ep_gc_push_root(&e2);
    ep_gc_push_root(&e3);
    ...
    x_twin = fraction_make(fraction_numerator(x), fraction_denominator(x));
    x_squared = fraction_multiply(x, x_twin);
    x_third = fraction_make(fraction_numerator(x), fraction_denominator(x));
    x_cubed = fraction_multiply(x_squared, x_third);
    ...
    ret_val = fraction_subtract(with_linear, e3);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(10);
    return ret_val;
...
long long down_root(long long which) {
    long long e2 = 0;
    long long e3 = 0;
    long long ret_val = 0;
    ...
    e2 = fraction_from_ratio(1, 8);
    e3 = down_second_invariant();
    if (which == 1) {
    ret_val = quark_root_in_bracket(1, 10000, 1, 20, e2, e3);
    goto L_cleanup;
    }
    if (which == 2) {
    ret_val = quark_root_in_bracket(1, 20, 7, 20, e2, e3);
    goto L_cleanup;
    }
    ret_val = quark_root_in_bracket(7, 10, 99, 100, e2, e3);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long up_root(long long which) {
    long long e2 = 0;
    long long e3 = 0;
    long long ret_val = 0;
    ...
    e2 = fraction_from_ratio(1, 12);
    e3 = up_second_invariant();
    if (which == 1) {
    ret_val = quark_root_in_bracket(1, 10000, 1, 20, e2, e3);
    goto L_cleanup;
    }
...
long long mass_share_of(long long root) {
    long long twin = 0;
    long long ret_val = 0;
    ...
    twin = fraction_make(fraction_numerator(root), fraction_denominator(root));
    ret_val = fraction_multiply(root, twin);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long bare_s_over_d() {
    long long central = 0;
    long long central_mass = 0;
    long long light = 0;
    long long light_mass = 0;
    long long ret_val = 0;

    ep_gc_push_root(&central);
    ep_gc_push_root(&central_mass);
    ep_gc_push_root(&light);
    ep_gc_push_root(&light_mass);

    ep_gc_maybe_collect();

    light = down_root(1);
    central = down_root(2);
    light_mass = mass_share_of(light);
    central_mass = mass_share_of(central);
    ret_val = fraction_divide(central_mass, light_mass);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(4);
    return ret_val;
...
long long bare_b_over_s() {
    ...
    long long central_mass = 0;
    long long heavy = 0;
    long long heavy_mass = 0;
    long long ret_val = 0;

    ep_gc_push_root(&central);
    ep_gc_push_root(&central_mass);
    ep_gc_push_root(&heavy);
    ep_gc_push_root(&heavy_mass);
    ...
    heavy = down_root(3);
    central_mass = mass_share_of(central);
    heavy_mass = mass_share_of(heavy);
    ret_val = fraction_divide(heavy_mass, central_mass);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(4);
    return ret_val;
...
long long brackets_carry_sign_changes() {
    long long at_hi = 0;
    long long at_lo = 0;
    long long at_mid_high = 0;
    long long at_mid_low = 0;
    long long e2 = 0;
    long long e3 = 0;
    ...
    long long s3 = 0;
    long long s4 = 0;
    long long second_change = 0;
    long long third_change = 0;
    long long zero = 0;
    long long ret_val = 0;

    ep_gc_push_root(&at_hi);
    ep_gc_push_root(&at_lo);
    ep_gc_push_root(&at_mid_high);
    ep_gc_push_root(&at_mid_low);
    ep_gc_push_root(&e2);
    ep_gc_push_root(&e3);
    ep_gc_push_root(&zero);
    ...
    e2 = fraction_from_ratio(1, 8);
    e3 = down_second_invariant();
    at_lo = quark_cubic_value(fraction_from_ratio(1, 10000), e2, e3);
    at_mid_low = quark_cubic_value(fraction_from_ratio(1, 20), e2, e3);
    at_mid_high = quark_cubic_value(fraction_from_ratio(7, 20), e2, e3);
    at_hi = quark_cubic_value(fraction_from_ratio(99, 100), e2, e3);
    s1 = fraction_compare(at_lo, zero);
    s2 = fraction_compare(at_mid_low, zero);
    s3 = fraction_compare(at_mid_high, zero);
    s4 = fraction_compare(at_hi, zero);
    first_change = s1 != s2;
    second_change = s2 != s3;
    third_change = s3 != s4;
    if (first_change) {
    if (second_change) {
    ret_val = third_change;
    goto L_cleanup;
    }
    ret_val = 0LL;
    goto L_cleanup;
