...
long long _main();
long long reach_ladder_size(long long);
long long reach_of(long long, long long);
long long light_reach(long long);
long long reach_equals_mass_ratio(long long);
long long heavy_parts_reach_one(long long);
long long reach_theorem_holds();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the reach ratios (lifetime and mass ratio are one count) ===");
    ok = expect_equal((long long)"light reach at d=1, RUN: 5 ticks (1 -> 5/6 -> ... -> 1/6)", int_to_string(light_reach(1)), (long long)"5");
    ok = expect_equal((long long)"light reach at d=2: 17 ticks", int_to_string(light_reach(2)), (long long)"17");
    ok = expect_equal((long long)"light reach at d=3: 53 ticks", int_to_string(light_reach(3)), (long long)"53");
    ok = expect_bool((long long)"the light reach EQUALS the mass ratio at every depth", reach_theorem_holds());
    ok = expect_equal((long long)"the middle part reaches exactly 1 tick", int_to_string(reach_of(1, 2)), (long long)"1");
    ok = expect_equal((long long)"the heavy part (5/6) reaches exactly 1 tick", int_to_string(reach_of(5, 6)), (long long)"1");
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long reach_ladder_size(long long d) {
    long long tower = 0;
    long long ret_val = 0;
    ...
    ret_val = (smallest_fold_period_above(1) * tower);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long reach_of(long long m_num, long long m_den) {
...
long long light_reach(long long d) {
    long long size = 0;
    long long ret_val = 0;
    ...
    size = reach_ladder_size(d);
    ret_val = reach_of(1, size);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    return ret_val;
...
long long reach_equals_mass_ratio(long long d) {
    long long reach = 0;
    long long size = 0;
    long long ret_val = 0;
...
long long heavy_parts_reach_one(long long d) {
    long long heavy_ok = 0;
    long long heavy_reach = 0;
    long long middle_ok = 0;
    long long middle_reach = 0;
    long long size = 0;
    long long ret_val = 0;
    ...
    middle_reach = reach_of(1, 2);
    size = reach_ladder_size(d);
    heavy_reach = reach_of((size - 1), size);
    middle_ok = middle_reach == 1;
    heavy_ok = heavy_reach == 1;
    if (middle_ok) {
    ret_val = heavy_ok;
    goto L_cleanup;
    }
...
long long reach_theorem_holds() {
    ...
    d = 1;
    while (d < 4) {
    light_ok = reach_equals_mass_ratio(d);
    heavy_ok = heavy_parts_reach_one(d);
    if (light_ok) {
    if (heavy_ok) {
    all_hold = all_hold;
    } else {
