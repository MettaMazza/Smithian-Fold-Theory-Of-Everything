...
long long _main();
long long subshell_capacity(long long);
long long electrons_after_cover(long long, long long);
long long subshell_count(long long, long long, long long);
long long noble_closure(long long);
long long closures_match_nobles();
long long smithium_8s();
long long smithium_5g();
long long smithium_valence();
long long valence_is_consistent();
long long g_block_opens_at_121();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== Smithium and the g-block (the chemistry of 126, forced) ===");
    ok = expect_equal((long long)"capacities: s = 2", int_to_string(subshell_capacity(0)), (long long)"2");
    ok = expect_equal((long long)"p = 6, d = 10, f = 14, g = 18 (g shown)", int_to_string(subshell_capacity(4)), (long long)"18");
    ok = expect_bool((long long)"THE SEVEN CLOSURES, walked: 2, 10, 18, 36, 54, 86, 118 exactly", closures_match_nobles());
    ok = expect_bool((long long)"the g-block opens at 121 (120 places nothing in 5g; 121 does)", g_block_opens_at_121());
    ok = expect_equal((long long)"SMITHIUM: the 8s pair = 2", int_to_string(smithium_8s()), (long long)"2");
    ok = expect_equal((long long)"SMITHIUM: the 5g count = 6", int_to_string(smithium_5g()), (long long)"6");
    ok = expect_equal((long long)"Smithium valence = 8 (oxidation +2 through +8)", int_to_string(smithium_valence()), (long long)"8");
    ok = expect_bool((long long)"the walk is consistent: valence = Z - [Og] core", valence_is_consistent());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long subshell_capacity(long long l) {
    long long ret_val = 0;

    ret_val = (smallest_fold_period_above(1) * ((2 * l) + 1));
    goto L_cleanup;
L_cleanup:
    return ret_val;
}

long long electrons_after_cover(long long z, long long cover) {
    long long c = 0;
    long long cap = 0;
    long long l = 0;
    long long left = 0;
    ...
    if (l < n) {
    if (left > 0) {
    cap = (smallest_fold_period_above(1) * ((2 * l) + 1));
    if (left > cap) {
    left = (left - cap);
    } else {
    left = 0;
...
long long subshell_count(long long z, long long n_target, long long l_target) {
    long long c = 0;
    long long cap = 0;
    long long l = 0;
    long long left = 0;
...
long long noble_closure(long long k) {
    long long c = 0;
    long long cap = 0;
    long long closures = 0;
    long long is_closure = 0;
    long long l = 0;
    long long n = 0;
    long long total = 0;
    long long ret_val = 0;
...
long long closures_match_nobles() {
    ...
    first = noble_closure(1) == 2;
    second = noble_closure(2) == 10;
    third = noble_closure(3) == 18;
    fourth = noble_closure(4) == 36;
    fifth = noble_closure(5) == 54;
    sixth = noble_closure(6) == 86;
    seventh = noble_closure(7) == 118;
    if (first) {
    if (second) {
    if (third) {
    if (fourth) {
...
long long smithium_8s() {
    ...
    ret_val = subshell_count(126, 8, 0);
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
...
long long smithium_5g() {
    ...
    ret_val = subshell_count(126, 5, 4);
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
...
long long smithium_valence() {
    ...
    s_part = subshell_count(126, 8, 0);
    g_part = subshell_count(126, 5, 4);
    ret_val = (s_part + g_part);
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
...
long long valence_is_consistent() {
    long long beyond_core = 0;
    long long walked = 0;
    long long ret_val = 0;

    walked = smithium_valence();
    beyond_core = (126 - noble_closure(7));
    ret_val = walked == beyond_core;
    goto L_cleanup;
L_cleanup:
    return ret_val;
}
...
long long g_block_opens_at_121() {
    long long at_120 = 0;
    long long at_121 = 0;
    long long closed_before = 0;
    long long open_after = 0;
    long long ret_val = 0;

    at_120 = subshell_count(120, 5, 4);
    at_121 = subshell_count(121, 5, 4);
    closed_before = at_120 == 0;
    open_after = at_121 == 1;
    if (closed_before) {
    ret_val = open_after;
    goto L_cleanup;
