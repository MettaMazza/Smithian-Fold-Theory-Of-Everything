...
long long fundamental_coupling_of(long long);
long long mixing_weight_of(long long);
long long mass_ratio_of(long long);
long long running_slope_of(long long);
long long ew_coupling_is_critical();
long long strong_coupling_matches_cycle();
long long slopes_match_running();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the interaction-strength table (four constants per sector) ===");
    ok = expect_equal((long long)"EW coupling g*(2) = 1/2", fraction_to_text(fundamental_coupling_of(2)), (long long)"1/2");
    ok = expect_equal((long long)"strong coupling g*(3) = 2/3", fraction_to_text(fundamental_coupling_of(3)), (long long)"2/3");
    ok = expect_equal((long long)"strong mixing weight = 1/2", fraction_to_text(mixing_weight_of(3)), (long long)"1/2");
    ok = expect_equal((long long)"strong mass ratio = 1/2", fraction_to_text(mass_ratio_of(3)), (long long)"1/2");
    ok = expect_equal((long long)"strong running slope = 2", int_to_string(running_slope_of(3)), (long long)"2");
    ok = expect_bool((long long)"g*(2) is the critical point (folds to unison)", ew_coupling_is_critical());
    ok = expect_bool((long long)"g*(3) matches the Yang-Mills self-coupling", strong_coupling_matches_cycle());
    ok = expect_bool((long long)"slopes from one formula: strong 2, abelian 0", slopes_match_running());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long fundamental_coupling_of(long long m) {
    long long ret_val = 0;
...
long long mixing_weight_of(long long m) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio(1, (m - 1));
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long mass_ratio_of(long long m) {
    long long ret_val = 0;
...
long long running_slope_of(long long m) {
    long long ret_val = 0;
...
long long strong_coupling_matches_cycle() {
    long long cycle_coupling = 0;
    long long g = 0;
    long long ret_val = 0;

    ep_gc_push_root(&cycle_coupling);
    ep_gc_push_root(&g);

    ep_gc_maybe_collect();

    g = fraction_from_ratio(2, 3);
    cycle_coupling = fraction_from_ratio(2, 3);
    ret_val = fraction_compare(g, cycle_coupling) == 0;
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
    free_struct_Fraction(cycle_coupling);
    cycle_coupling = 0;
    free_struct_Fraction(g);
    g = 0;
    return ret_val;
}
