...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the cosmic energy budget ===");
    ok = expect_equal((long long)"dark energy Omega_Lambda = 2/3", fraction_to_text(dark_energy_density()), (long long)"2/3");
    ok = expect_equal((long long)"matter Omega_matter = 1/3", fraction_to_text(matter_density()), (long long)"1/3");
    ok = expect_equal((long long)"dark energy + matter = the One (flat)", fraction_to_text(flat_universe_partition()), (long long)"1");
    ok = expect_equal((long long)"baryon Omega_baryon = 5/96", fraction_to_text(baryon_density()), (long long)"5/96");
    ok = expect_equal((long long)"cold dark matter Omega_cdm = 9/32", fraction_to_text(cold_dark_matter_density()), (long long)"9/32");
    printf("%s\n", (char*)(long long)"--- forced vs measured (Planck) ---");
    ok = expect_equal((long long)"Omega_Lambda forced = 0.6666 (measured ~0.689)", fraction_to_decimal(dark_energy_density(), 4), (long long)"0.6666");
    ok = expect_equal((long long)"Omega_matter forced = 0.3333 (measured ~0.311)", fraction_to_decimal(matter_density(), 4), (long long)"0.3333");
    ok = expect_equal((long long)"Omega_baryon forced = 0.0520 (measured ~0.0493)", fraction_to_decimal(baryon_density(), 4), (long long)"0.0520");
    ok = expect_equal((long long)"Omega_cdm forced = 0.2812 (measured ~0.262)", fraction_to_decimal(cold_dark_matter_density(), 4), (long long)"0.2812");
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
