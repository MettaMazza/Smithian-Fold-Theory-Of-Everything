...
long long _main();
long long ladder_size(long long);
long long light_part(long long);
long long central_part();
long long heavy_part(long long);
long long complement_identity_holds(long long);
long long family_ratio(long long);
long long ratio_is_ladder_count_less_one(long long);
long long family_holds();
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== the mass-ratio family (heavy over light = 2*3^d - 1) ===");
    ok = expect_equal((long long)"the ladder size at d=1: N = 6", int_to_string(ladder_size(1)), (long long)"6");
    ok = expect_equal((long long)"the d=1 diagonal: light 1/6", fraction_to_text(light_part(1)), (long long)"1/6");
    ok = expect_equal((long long)"heavy = the complement 5/6", fraction_to_text(heavy_part(1)), (long long)"5/6");
    ok = expect_equal((long long)"the family ratio at d=1: 5", fraction_to_text(family_ratio(1)), (long long)"5");
    ok = expect_equal((long long)"at d=2: 17", fraction_to_text(family_ratio(2)), (long long)"17");
    ok = expect_equal((long long)"at d=3: 53", fraction_to_text(family_ratio(3)), (long long)"53");
    ok = expect_bool((long long)"the family holds: ratio = N_d - 1 at every depth (both routes)", family_holds());
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long ladder_size(long long d) {
    long long reach = 0;
    long long ret_val = 0;
    ...
    reach = whole_power(colour_count(), d);
    ret_val = (smallest_fold_period_above(1) * reach);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long light_part(long long d) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio(1, ladder_size(d));
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long heavy_part(long long d) {
    long long light = 0;
    long long one = 0;
    long long ret_val = 0;
    ...
    light = fraction_from_ratio(1, ladder_size(d));
    ret_val = fraction_subtract(one, light);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(3);
    return ret_val;
...
long long complement_identity_holds(long long d) {
    long long heavy = 0;
    long long size = 0;
    long long target = 0;
    long long ret_val = 0;
    ...
    heavy = heavy_part(d);
    size = ladder_size(d);
    target = fraction_from_ratio((size - 1), size);
    ret_val = fraction_compare(heavy, target) == 0;
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(4);
    free_struct_Fraction(heavy);
    heavy = 0;
...
long long family_ratio(long long d) {
    long long heavy = 0;
    long long light = 0;
    long long ret_val = 0;
    ...
    heavy = heavy_part(d);
    light = fraction_from_ratio(1, ladder_size(d));
    ret_val = fraction_divide(heavy, light);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(3);
    return ret_val;
...
long long ratio_is_ladder_count_less_one(long long d) {
    long long ratio = 0;
    long long size = 0;
    long long target = 0;
    long long ret_val = 0;
    ...
    ratio = family_ratio(d);
    size = ladder_size(d);
    target = fraction_from_whole_number((size - 1));
    ret_val = fraction_compare(ratio, target) == 0;
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(4);
...
long long family_holds() {
    ...
    at_one = ratio_is_ladder_count_less_one(1);
    at_two = ratio_is_ladder_count_less_one(2);
    at_three = ratio_is_ladder_count_less_one(3);
    c_one = complement_identity_holds(1);
    c_two = complement_identity_holds(2);
    c_three = complement_identity_holds(3);
    if (at_one) {
    if (at_two) {
    if (at_three) {
    if (c_one) {
