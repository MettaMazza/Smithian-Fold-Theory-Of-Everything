...
long long _main();
long long coupling_on_source(long long);
long long strong_coupling(long long);
long long ew_coupling(long long);
long long coupling_gap(long long);
long long strong_bare();
long long ew_bare();
long long gap_shrinks_with_depth(long long);
long long strong_climbs_toward_one(long long);
...
long long _main() {
    ...
    printf("%s\n", (char*)(long long)"=== coupling convergence (grand unification) ===");
    ok = expect_equal((long long)"strong bare coupling = 2/3", fraction_to_text(strong_bare()), (long long)"2/3");
    ok = expect_equal((long long)"electroweak bare coupling = 1/2", fraction_to_text(ew_bare()), (long long)"1/2");
    ok = expect_equal((long long)"bare gap = 2/3 - 1/2 = 1/6", fraction_to_text(coupling_gap(0)), (long long)"1/6");
    ok = expect_equal((long long)"gap at depth 1 = 3/4 - 2/3 = 1/12 (shrinking)", fraction_to_text(coupling_gap(1)), (long long)"1/12");
    ok = expect_bool((long long)"the gap shrinks with depth (couplings converge)", gap_shrinks_with_depth(0));
    ok = expect_bool((long long)"the strong coupling climbs toward the One", strong_climbs_toward_one(1));
    printf("%s\n", (char*)(long long)"=== done ===");
    ret_val = 0;
    goto L_cleanup;
L_cleanup:
...
long long coupling_on_source(long long s) {
    long long ret_val = 0;
    ...
    ret_val = fraction_from_ratio((s - 1), s);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(1);
    return ret_val;
...
long long strong_coupling(long long d) {
    long long source = 0;
    long long ret_val = 0;
    ...
    source = ((smallest_fold_period_above(binary_count()) + whole_power(binary_count(), d)) - 1);
...
long long ew_coupling(long long d) {
    long long source = 0;
    long long ret_val = 0;
    ...
    source = ((smallest_fold_period_above(1) + whole_power(binary_count(), d)) - 1);
    ret_val = fraction_from_ratio((source - 1), source);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(2);
...
long long coupling_gap(long long d) {
    long long ew = 0;
    long long strong = 0;
    long long ret_val = 0;
    ...
    strong = strong_coupling(d);
    ew = ew_coupling(d);
    ret_val = fraction_subtract(strong, ew);
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(3);
    return ret_val;
...
long long ew_bare() {
    ...
    ret_val = ew_coupling(0);
    goto L_cleanup;
L_cleanup:
    return ret_val;
}

long long gap_shrinks_with_depth(long long d) {
    ...
    here = coupling_gap(d);
    deeper = coupling_gap((d + 1));
    comparison = fraction_compare(deeper, here);
...
long long strong_climbs_toward_one(long long d) {
    long long bare = 0;
    long long comparison = 0;
    long long deeper = 0;
    long long ret_val = 0;
    ...
    bare = strong_coupling(0);
    deeper = strong_coupling(d);
    comparison = fraction_compare(deeper, bare);
    ret_val = comparison > 0;
    goto L_cleanup;
L_cleanup:
    ep_gc_pop_roots(3);
