...
| `10.5281/zenodo.21282589` | Discrete Navier-Stokes regularity | 2 | **KEEP — substantive derivation** | Completely rebuilt around the exact `1/32 -> 32` theorem and corrected full-grid material verification. The applied run now measures all 512 cells, moves the global maximum `800 -> 32`, preserves density `150 -> 150`, and states the relation between the derived discrete physical object and the classical continuum formulation. PDF-first edition is publication-ready. |
