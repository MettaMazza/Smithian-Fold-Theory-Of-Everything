...
| `10.5281/zenodo.21026491` | The continuum was the bug | 1 | **KEEP — substantive structural synthesis** | Rebuilt from the current Riemann-axis, Yang-Mills, Navier-Stokes, continuum-curvature and finite-ladder certificates. The edition corrects the old symmetry-only Riemann inference and the obsolete Yang-Mills floor value while preserving the argument for a derived physical substrate rather than continuum-only authority. PDF-first edition is publication-ready. |
