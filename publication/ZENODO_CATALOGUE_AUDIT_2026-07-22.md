...
| `10.5281/zenodo.21320952` | Hubble tension and cosmological constant | 3 | **KEEP — substantive derivation** | Rewritten from the current cosmology engines as a complete paper: exact `3305/3048` calibration, unique deepening, registered five-parts-per-million empirical comparison, positive half-One vacuum and single `127/2` scale axis. PDF-first edition is publication-ready. |
