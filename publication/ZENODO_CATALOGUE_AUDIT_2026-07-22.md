...
| `10.5281/zenodo.21026618` | The constants are one object | 1 | **KEEP — substantive synthesis** | Rebuilt against the current Grand Lock and zero-axiom foundation. The new edition distinguishes the exact foundation-order dependency test from completed alpha, Hubble and dark-to-baryon deepenings, records the colour-mutation control, and uses the current 326-suite/2,002-check release evidence. PDF-first edition is publication-ready. |
