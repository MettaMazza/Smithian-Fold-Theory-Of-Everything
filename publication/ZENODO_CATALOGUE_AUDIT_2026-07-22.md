...
| `10.5281/zenodo.21026491` | The continuum was the bug | 1 | **KEEP — substantive structural synthesis** | Rebuilt from the complete cross-referenced Riemann-axis, fold-number-theory, counterfactual, Yang-Mills, Navier-Stokes, continuum-curvature and finite-ladder routes. The edition preserves the corpus's self-dual zero-spectrum argument, corrects the obsolete Yang-Mills floor wording to the engine-derived `1/3` gap share, and establishes the finite positive fold as the governing substrate rather than measuring it against incumbent continuum authority. PDF-first edition is publication-ready. |
